...
switch ($_GET["op"]) {
  ...
  case 'verificar':
    ...
    if (!empty($rspta['data']['usuario'])) {
      ...
      in_array(22, $valores) ? $_SESSION['retraso_de_cobro']          = 1 : $_SESSION['retraso_de_cobro']          = 0;
      in_array(23, $valores) ? $_SESSION['avance_de_cobro']           = 1 : $_SESSION['avance_de_cobro']           = 0;
      in_array(24, $valores) ? $_SESSION['cobro_por_trabajador']      = 1 : $_SESSION['cobro_por_trabajador']      = 0;
      in_array(25, $valores) ? $_SESSION['correo_enviado']            = 1 : $_SESSION['correo_enviado']            = 0;
      in_array(26, $valores) ? $_SESSION['usuario']                   = 1 : $_SESSION['usuario']                   = 0;
      ...
      in_array(32, $valores) ? $_SESSION['empresa_configuracion']     = 1 : $_SESSION['empresa_configuracion']     = 0;
      in_array(33, $valores) ? $_SESSION['configuracion']             = 1 : $_SESSION['configuracion']             = 0;
