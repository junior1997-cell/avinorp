            ...
            $data[] = [
              ...
              "1" => '<div class="btn-group ">
                ...
                <ul class="dropdown-menu">'.                  
                  ...
                  ( in_array($value['sunat_estado'], $valores_sunat) || $value['tipo_comprobante'] == '12'  ? '<li><a class="dropdown-item text-success" href="javascript:void(0);" onclick="ver_editar_venta(' . $value['idventa'] . ');" ><i class="bi bi-pencil"></i> Editar</a></li>':'').
                  ...
                  '.( $value['tipo_comprobante'] == '12' ? '<li><a class="dropdown-item text-danger" href="javascript:void(0);" onclick="eliminar_papelera_venta(' . $value['idventa'] .', \''. '<b>'.$value['tipo_comprobante_v2'].' </b>' .  $value['serie_comprobante'] . '-' . $value['numero_comprobante'] . '\');" ><i class="bx bx-trash"></i> Eliminar o papelera </a></li>' : '').'  
