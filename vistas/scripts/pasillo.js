...
function listar_categoria(){
  tabla_categoria = $('#tabla-categoria').dataTable({
    ...
    "ajax":	{
			url: '../ajax/pasillo.php?op=listar_tabla_categoria',
			type: "get",
			dataType: "json",
			error: function (e) {
...
function guardar_editar_categoria(e){
  ...
  $.ajax({
    url: "../ajax/pasillo.php?op=guardar_editar_cat",
    type: "POST",
    data: formData,
    contentType: false,
    processData: false, 
...
function mostrar_categoria(idproducto_categoria_ubicacion){
  $(".tooltip").remove();
  ...
  $.post("../ajax/pasillo.php?op=mostrar_categoria", { idproducto_categoria_ubicacion: idproducto_categoria_ubicacion }, function (e, status) {
    e = JSON.parse(e); 
    if (e.status) {
      $("#idproducto_categoria_ubicacion").val(e.data.idproducto_categoria_ubicacion);
...
function eliminar_papelera_categoria(idproducto_categoria_ubicacion, nombre){
  crud_eliminar_papelera(
    "../ajax/pasillo.php?op=desactivar",
    "../ajax/pasillo.php?op=eliminar", 
    idproducto_categoria_ubicacion, 
    "!Elija una opción¡", 
